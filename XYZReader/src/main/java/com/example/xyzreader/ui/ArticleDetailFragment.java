...
public class ArticleDetailFragment extends Fragment implements
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        fab1 = (FloatingActionButton) mRootView.findViewById(R.id.share_fab);

        Toolbar toolbar = (Toolbar)mRootView.findViewById(R.id.detail_toolbar);
        ((AppCompatActivity)getActivity()).setSupportActionBar(toolbar);

        collapsingToolbarLayout = (CollapsingToolbarLayout) mRootView.findViewById(R.id.detail_toolbar_layout);
   ...
   //     collapsingToolbarLayout.setCollapsedTitleGravity(1);
    ...
    private void bindViews() {
        ...
        if (mCursor != null) {
            ...
            if(mCursor.getString(ArticleLoader.Query.TITLE).length() > 25){
                collapsingToolbarLayout.setExpandedTitleTextAppearance(R.style.LongTitle);
            }
            if(mCursor.getString(ArticleLoader.Query.TITLE).length() > 35){
                    ...
                    .get(mCursor.getString(ArticleLoader.Query.PHOTO_URL), new ImageLoader.ImageListener() {
                        ...
                        public void onResponse(ImageLoader.ImageContainer imageContainer, boolean b) {
                            ...
                            if (bitmap != null) {
                                ...
                                mRootView.findViewById(R.id.scrim_top)
                                        .setBackgroundColor(mMutedColor);
                                mRootView.findViewById(R.id.scrim_bottom)
                                    .setBackgroundColor(mMutedColor);
